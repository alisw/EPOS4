 ...
 * @param [in] c Table containing constant indices
 *
 */
 ...
 * @param [in] pos  Absolute position of the cube point (0,0,0) 
 *
 */
 ...
 * @param [in] donocheck 1 if no check is needed, 0 otherwise
 *
 ...
 * @param [in] c_v Values for the constant indices
 ...
 * @param [in] c_v   Value for the constant index
