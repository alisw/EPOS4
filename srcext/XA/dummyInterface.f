...
!-----------------------------------------------------------------------
!> @brief
!> dummy interface for subroutine aacharm2
!-----------------------------------------------------------------------
      subroutine aacharm2
      end subroutine aacharm2

!-----------------------------------------------------------------------
!> @brief
!> dummy interface for subroutine aacharmclose
!-----------------------------------------------------------------------
      subroutine aacharmclose
      end subroutine aacharmclose

!-----------------------------------------------------------------------
!> @brief
!> dummy interface for subroutine useHydroTable
!-----------------------------------------------------------------------
      subroutine useHydroTable
      end subroutine useHydroTable

!-----------------------------------------------------------------------
!> @brief
!> dummy interface for subroutine finish_program
!-----------------------------------------------------------------------
...
!-----------------------------------------------------------------------
!> @brief
!> dummy interface for subroutine transfer_head
!>
!> @param[in] iversn
!> @param[in] laproj
!> @param[in] maproj
...
!-----------------------------------------------------------------------
      ...
      end subroutine transfer_head


!-----------------------------------------------------------------------
!> @brief
!> dummy interface for subroutine transfer_event
!>
!> @param[in] izmode
!> @param[in] cnt
!> @param[in] np
